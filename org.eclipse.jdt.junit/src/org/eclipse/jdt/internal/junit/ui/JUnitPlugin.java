...
public class JUnitPlugin extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID= "edu.uiuc.cs427.nibbler.fruit.punit";
	...
	public static final String ID_EXTENSION_POINT_TESTRUN_LISTENERS= "edu.uiuc.cs427.nibbler.fruit.punit" + "." + "testRunListeners"; //$NON-NLS-1$ //$NON-NLS-2$
	public static final String ID_EXTENSION_POINT_JUNIT_LAUNCHCONFIGS= "edu.uiuc.cs427.nibbler.fruit.punit" + "." + "junitLaunchConfigs"; //$NON-NLS-1$ //$NON-NLS-2$
	public static final String ID_EXTENSION_POINT_TEST_KINDS= "edu.uiuc.cs427.nibbler.fruit.punit" + "." + "internal_testKinds"; //$NON-NLS-1$ //$NON-NLS-2$
